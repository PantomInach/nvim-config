...
_G.packer_plugins = {
  ...
  decay = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/decay",
  ...
  ["hop.nvim"] = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/hop.nvim",
    url = "https://github.com/phaazon/hop.nvim"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["nvim-comment"] = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/nvim-comment",
  ...
  undotree = {
    loaded = true,
    path = "/home/aaron/.local/share/nvim/site/pack/packer/start/undotree",
